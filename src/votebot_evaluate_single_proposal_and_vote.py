...
MAGI_MODELS_DEFAULT = {
    "balthazar": "openrouter/google/gemini-2.5-flash-thinking-exp",
    "melchior": "openrouter/google/gemini-2.5-pro-exp",
    "caspar": "openrouter/google/gemini-1.5-pro",
}
...
def perform_preflight_checks_firestore(db, proposal_doc_ref) -> Tuple[List[Dict], Path, List[str]]:
    ...
    manifest_inputs.append(
        {"logical_name": "raw_subsquare_data", "firestore_path": f"proposals/{proposal_doc_ref.id}/files/rawData", "hash": hash_file(local_raw_path)}
    )
    logger.info("✅ raw_subsquare.json validated and saved locally.")
